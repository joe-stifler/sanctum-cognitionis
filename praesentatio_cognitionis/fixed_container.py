# This code is a direct copy from: https://gist.github.com/toolittlecakes/cf1a5d734cbf5b0b2581c28b2530fec2
...
def st_fixed_container(
    *,
    ...
    with fixed_container:
        ...
        st.markdown(
            f"<div class='fixed-container-{id}'></div>",
